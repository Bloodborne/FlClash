...
as String?,trayIconUseTemplate: null == trayIconUseTemplate ? _self.trayIconUseTemplate : trayIconUseTemplate // ignore: cast_nullable_to_non_nullable
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.showNotificationStopAction = true, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = true, this.showLabel = false, this.disclaimerAccepted = false, this.crashlyticsTip = false, this.crashlytics = false, this.minimizeOnExit = true, this.hidden = false, this.developerMode = false, this.restoreStrategy = RestoreStrategy.compatible, this.showTrayTitle = true, this.trayIconStoppedPath, this.trayIconProxyPath, this.trayIconTunPath, this.trayIconUseTemplate = false, this.checkCertificate = true, this.customUserAgent = ''}): _dashboardWidgets = dashboardWidgets;
...
@override@JsonKey() final  String? trayIconStoppedPath;
@override@JsonKey() final  String? trayIconProxyPath;
@override@JsonKey() final  String? trayIconTunPath;
@override@JsonKey() final  bool trayIconUseTemplate;
